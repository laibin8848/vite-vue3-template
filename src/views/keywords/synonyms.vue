<template>
  <div>
    <el-alert style="font-size: 16px;" :title="`当前正在维护关键词 [${$route.query.name || '--'}] 下的近义词`" type="success" :closable="false" />
    <div class="global-tab-con">
      ...
      <el-table border v-loading="pageParams.loading" :data="pageDatas" class="table" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="name" label="近义词名称" align="center"></el-table-column>
